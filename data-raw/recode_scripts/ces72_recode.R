...
#recode Province (m_area_a)
# look_for(ces72_nov, "province")
ces72_nov$prov<-Recode(ces72_nov$m_area_a, "0=6; 1=5; 2=10; 3=9; 4=8; 5=7; 6=3; 7=4; 8=1; 9=2")
val_labels(ces72_nov$prov)<-c(NL=1, PE=2, NS=3, NB=4, QC=5, ON=6, MB=7, SK=8, AB=9, BC=10)
#checks
val_labels(ces72_nov$prov)
table(ces72_nov$prov)
...
#recode Party ID 2 (qi)
# look_for(ces72_nov, "federal")
ces72_nov$party_id2<-Recode(ces72_nov$qi, "3=1; 1=2; 4=3; 2=0; else=NA")
val_labels(ces72_nov$party_id2)<-c(Other=0, Liberal=1, Conservative=2, NDP=3)
#checks
val_labels(ces72_nov$party_id2)
table(ces72_nov$party_id2, ces72_nov$qi)

#recode Party closeness (not available)
