...
library(stringr)
library(here)
#Check to see if the ces21.rda does not exist
if (!file.exists(here("data/ces21.rda"))) {
...
ces21$environment<-Recode(ces21$cps21_spend_env, "3=0.5; 1=1; 2=0; else=NA")
...
look_for(ces21, "rich")
ces21$redistribution<-Recode(ces21$pes21_gap, "1=1; 2=0.75; 3=0.5; 4=0.25; 5=0; else=NA", as.numeric=T)
#val_labels(ces21$redistribution)<-c(Much_less=0, Somewhat_less=0.25, Same_amount=0.5, Somewhat_more=0.75, Much_more=1)
#checks
val_labels(ces21$redistribution)
...
ces21$liberal_rating<-Recode(ces21$cps21_party_rating_23, "-99=NA")
table(ces21$liberal_rating)

#recode Conservative rating
ces21$conservative_rating<-Recode(ces21$cps21_party_rating_24, "-99=NA")
...
#recode Green rating
ces21$green_rating<-Recode(ces21$cps21_party_rating_27, "-99=NA")
table(ces21$green_rating)

#recode PPC rating
ces21$ppc_rating<-Recode(ces21$cps21_party_rating_29, "-99=NA")
...
ces21$quebec_accom<-Recode(ces21$pes21_doneqc, "2=0.25; 1=0; 3=0.5; 4=0.75; 5=1; else=NA")
#checks
...
look_for(ces21, "education")
ces21$education<-Recode(ces21$cps21_spend_educ, "3:4=0.5; 1=1; 2=0; else=NA")
...
look_for(ces21, "env")
ces21$enviro<-Recode(ces21$cps21_spend_env, "1=0; 2=0.5; 3=1; else=NA")
#checks
...
ces21$ideology<-Recode(ces21$cps21_lr_scale_bef_1, "0=0; 1=0.1; 2=0.2; 3=0.3; 4=0.4; 5=0.5; 6=0.6; 7=0.7; 8=0.8; 9=0.9; 10=1; -99=NA; else=NA")
...
ces21$immigration_job<-Recode(ces21$pes21_immigjobs, "1=0; 2=0.25; 3=0.75; 4=1; else=NA", as.numeric=T)
#checks
