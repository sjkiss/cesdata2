...
#recode Unemployed (v54)
# look_for(ces65, "employ")
ces65$unemployed<-Recode(ces65$v54, "1=1; 2=0; else=NA")
val_labels(ces65$unemployed)<-c(Employed=0, Unemployed=1)
#checks
val_labels(ces65$unemployed)
# table(ces65$unemployed)
...
#recode Party ID 2 (v221)
# look_for(ces65, "identification")
ces65$party_id2<-Recode(ces65$v221, "20=1; 10=2; 30=3; 40:70=0; else=NA")
val_labels(ces65$party_id2)<-c(Other=0, Liberal=1, Conservative=2, NDP=3)
#checks
val_labels(ces65$party_id2)
table(ces65$party_id2, ces65$v221)

#recode Party closeness (v222)
look_for(ces65, "strength")
ces65$party_close<-Recode(ces65$v222  , "1=1; 2=0.5; 3=0; else=NA")
#checks
table(ces65$v222   , ces65$party_close, useNA = "ifany" )
...
# look_for(ces65, "most")
ces65$mip<-Recode(ces65$v8a, "11=18; 12:13=7; 14=6; 15=0; 16:17=15; 18=8; 19=0; 20=4; 21:22=14; 23:26=12;
...
#recode Provincial Vote (v269)
# look_for(ces65, "vote")
ces65$prov_vote<-car::Recode(as.numeric(ces65$v269), "12=1; 11=2; 13=3; 14:16=0; else=NA")
val_labels(ces65$prov_vote)<-c(Other=0, Liberal=1, Conservative=2, NDP=3, PQ=4, Green=5)
#checks
val_labels(ces65$prov_vote)
table(ces65$prov_vote)
